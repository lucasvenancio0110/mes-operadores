...
window.addEventListener('DOMContentLoaded', async () => {
  try {
    await Promise.all([
      loadApplicationStyle('branding.css?v=20260802-11'),
      loadApplicationStyle('operations.css?v=20260802-11'),
      loadApplicationStyle('assignment-confirm.css?v=20260802-11'),
      loadApplicationStyle('production-entry.css?v=20260802-11'),
      loadApplicationStyle('no-sequence.css?v=20260802-11')
    ]);
    await loadApplicationScript('branding.js?v=20260802-11');
    await loadApplicationScript('learning-ui.js?v=20260802-11');
    await loadApplicationScript('session-v2.js?v=20260802-11');
    await loadApplicationScript('shift-authority.js?v=20260802-11');
    await loadApplicationScript('assignment-confirm.js?v=20260802-11');
    await loadApplicationScript('master-data.js?v=20260802-11');
    await loadApplicationScript('no-sequence.js?v=20260802-11');
    await loadApplicationScript('production-entry.js?v=20260802-11');
  } catch (error) {
