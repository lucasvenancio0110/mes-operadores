...
window.addEventListener('DOMContentLoaded', async () => {
  try {
    await Promise.all([
      loadApplicationStyle('branding.css?v=20260802-6'),
      loadApplicationStyle('operations.css?v=20260802-6'),
      loadApplicationStyle('assignment-confirm.css?v=20260802-6')
    ]);
    await loadApplicationScript('branding.js?v=20260802-6');
    await loadApplicationScript('learning-ui.js?v=20260802-6');
    await loadApplicationScript('session-v2.js?v=20260802-6');
    await loadApplicationScript('assignment-confirm.js?v=20260802-6');
    await loadApplicationScript('master-data.js?v=20260802-6');
  } catch (error) {
